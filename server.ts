    ...
    for (const art of articles) {
      await pool.query(
        ...
        [sourceId, art.article_number, art.title, art.official_text, art.infraction, art.min_sentence_years,
         art.max_sentence_years, (art as any).fine_min_fcfa, (art as any).fine_max_fcfa, (art as any).prescription_years, (art as any).procedure_type,
    ...
    for (const art of articles) {
      await pool.query(
        ...
        [sourceId, art.article_number, art.title, art.official_text,
         ...
         (art as any).fine_min_fcfa ?? null, (art as any).fine_max_fcfa ?? null,
         (art as any).procedure_type ?? null,
         (art as any).prescription_years ?? null,
